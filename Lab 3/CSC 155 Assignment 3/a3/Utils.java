...
{	public Utils() {}
	...
	// CHROME material - ambient, diffuse, specular, and shininess (values obtained from http://www.barradeau.com/nicoptere/dump/materials.html)
	public static float[] chromeAmbient()  { return (new float[] {0.25f, 	 0.25f, 	0.25f, 	   1} ); }
	public static float[] chromeDiffuse()  { return (new float[] {0.4f, 	 0.4f, 		0.4f, 	   1} ); }
	public static float[] chromeSpecular() { return (new float[] {0.774597f, 0.774597f, 0.774597f, 1} ); }
	public static float chromeShininess() { return 76.8f; }
}